...
/**
 * Dataset geográfico oficial de Costa Rica.
 * 7 provincias → 84 cantones → distritos (División Territorial
 * Administrativa oficial IGN/SNITCR 2022, 492 distritos).
 *
 * Es la ÚNICA fuente de la que se alimentan ApiController (autocompletar
 * formularios y geolocalización), la helper format_venue_location() y el
 * script de normalización (DataBase/ScriptsSQL/normalize_locations.php).
 *
